...
const createStyles = () => __awaiter(this, void 0, void 0, function* () {
    selection.forEach((textNode) => __awaiter(this, void 0, void 0, function* () {
        if (textNode.name.startsWith("Frame") ||
            textNode.name.startsWith("Artboard")) {
            Promise.reject("Rename first");
            figma.closePlugin("Press CMD(CTRL)+R and rename your layers to include / separators");
        }
    ...
    selection.forEach((shapeNode) => __awaiter(this, void 0, void 0, function* () {
        if (shapeNode.name.startsWith("Frame") ||
    ...
    selection.forEach((effectNode) => __awaiter(this, void 0, void 0, function* () {
        if (effectNode.name.startsWith("Frame") ||
            effectNode.name.startsWith("Artboard")) {
            figma.closePlugin("Press CMD(CTRL)+R and rename your Text layers to include / separators");
            Promise.reject("Rename first");
        }
        else if (effectNode.type === "FRAME" ||
